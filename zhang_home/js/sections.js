...
var scrollVis = function () {
    ...
    var setupVis = function (wordData, fillerCounts, histData) {
        ...
        g.append('text')
            ...
            .attr('x', width / 2)
            .attr('y', height / 3)
            .text('2016-2020').attr('font-family', 'Arial').attr('font-weight',500);

        g.append('text')
            .attr('class', 'sub-title openvis-title')
            .attr('x', width / 2)
            .attr('y', (height / 3) + (height / 5))
            .text('Traffic Accident').attr('font-family', 'Arial').attr('font-weight',500);
...
// 第二快count-title
        g.append('text')
            ...
            .attr('y', height / 3)
            .text('2906610')
            .style("fill", "red").attr('font-family', 'Arial')

        g.append('text')
            .attr('class', 'sub-title count-title')
            .attr('x', width / 2)
            .attr('y', (height / 3) + (height / 5))
            .text('In the U.S.').attr('font-family', 'Arial').attr('font-weight',500)
  ...
  function highlightGrid() {
    ...
    g.selectAll('.fill-square')
      ...
      .duration(800)
      .attr('opacity', 1.0)
      .attr('fill', function (d) { return d.filler ? '#d9d9d9' : '#d9d9d9'; });
  }
